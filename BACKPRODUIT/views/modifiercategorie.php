...
session_start();
  ...
  if(isset($_GET['id'])){
    $p = new CategorieC();
    $categorie = $p->afficherCategorieParId($_GET['id']);
  }  
  if(isset($_POST['modifier-p'])){
    $pam = new Categorie(null);
   $pam->setId($_GET['id']);
    $pam->setNom($_POST['nom-c']);
   
    $p->ModifierCategorie($pam);
  }
?>
        ...
        <div class="right_col" role="main">
          ...
          <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" name="nom-c" class="form-control" value="<?php echo $categorie['nom_categorie']; ?>">
            </div>
            ...
            <a class="btn btn-primary" href="affichercategorie.php">liste des categories</a>
          </form>
        </div>
      </div>
            </div>
