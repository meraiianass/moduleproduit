      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php" class="site_title"><i class="fa fa-paw"></i> <span>Fitness Shop!</span></a>
            </div>
        ...
        <div class="right_col" role="main">
          <table class="table">
            ...
            ?>
            <tr>
              <td><?php echo $l['id_categorie'] ?></td>
              
              <td><?php echo $l['nom_categorie'] ?></td>
             
              
              <td>
                <a href="modifiercategorie.php?id=<?php echo $l['id_categorie'] ?>">Modifier</a>
                <a href="supprimercategorie.php?id=<?php echo $l['id_categorie'] ?>">Supprimer</a>
              </td>
            </tr>
            <?php } ?>
          </table>
          <div class="form-actions">
          <a class="btn btn-success" href="ajoutercategorie.php">ajouter</a>  
          </div>
